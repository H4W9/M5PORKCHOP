...
void Mood::draw(M5Canvas& canvas) {
    ...
    if (atLeftEdge) {
        ...
        bubbleY = 23 + SCENE_GROUND_SHIFT;  // At pig ear level (follows the pig down on tall panes)
    } else if (atRightEdge) {
        ...
        int arrowTipY = 20 + SCENE_GROUND_SHIFT;  // Point at pig's ear area
    ...
    if (mode == BubbleMode::LEFT_EDGE) {
        ...
        int arrowTipY = 20 + SCENE_GROUND_SHIFT;  // Point at pig's ear area (updated for new head Y)

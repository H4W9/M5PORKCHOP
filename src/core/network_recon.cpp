...
#ifdef PORKCHOP_PANCAKE
    // Dual-band (ESP32-C5): 2.4 GHz 1-14 and 5 GHz 36-177. Reject the
    // non-existent 15-35 gap; esp_wifi_set_channel validates the rest.
    return (channel >= 1 && channel <= 14) || (channel >= 36 && channel <= 177);
#else
